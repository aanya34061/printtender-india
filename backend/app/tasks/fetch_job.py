    ...
    *,
    ...
    if include_newspapers:
        ...
        newspaper_scrapers = [
            ...
            ("Nav Bharat", scrape_navbharat),
            ("Dainik Jagran", scrape_jagran),
            ("Amar Ujala", scrape_amarujala),
            ("Deshbandhu", scrape_deshbandhu),
            ("Raj Express", scrape_rajexpress),
            ("Peoples Samachar", scrape_peoplessamachar),
            ("Dabang Dunia", scrape_dabangdunia),
            ("Free Press Journal", scrape_freepressjournal),
            ("Pradesh Today", scrape_pradeshtoday),
            ("Agniban", scrape_agniban),
            ("Nav Swadesh", scrape_navswadesh),
            ("Swadesh", scrape_swadesh),
            ("Hari Bhoomi", scrape_haribhoomi),
